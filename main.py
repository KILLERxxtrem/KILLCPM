...
__GROUP_USERNAME__   = "t.me/KILLER777cpm"
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, f' ‌           INSTAGRAM: @{eukillerofc} WHATSAPP @{t.me/KILLER777cpm}'))
    print(Colorate.Horizontal(Colors.rainbow, '=================================================================='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{22}: DESBLOQUEAR ROUPAS M 3.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{23}: DESBLOQUEAR ROUPAS F  3.000K'))
            ...
            if service == 0: # Exit
                print(Colorate.Horizontal(Colors.rainbow, f'VOLTE SEMPRE....: @{eukillerofc}.'))
                ...
                if amount > 0 and amount <= 999999999:
                    if cpm.set_player_money(amount):
                        ...
                        if answ == "y": print(Colorate.Horizontal(Colors.rainbow, f' VOLTE SEMPRE : @{eukillerofc}.'))
                        else: continue
                    else:
                ...
                if cpm.set_player_plates():
                    ...
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    answ = Prompt.ask("[?] DESEJA SAIR ? USE Y PARA SIM E N PARA NAO ?", choices=["y", "n"], default="n")
                    if answ == "y": print(Colorate.Horizontal(Colors.rainbow, f'VOLTR SEMPRE....: @{eukillerofc}.'))
                    else: continue
                else:
                    print(Colorate.Horizontal(Colors.rainbow, 'FALHA.'))
                    print(Colorate.Horizontal(Colors.rainbow, 'TENTE NOVAMENTE.'))
                ...
                if amount > 0 and amount <= 999999999999999999999999999:
                    if cpm.set_player_wins(amount):
                        ...
                        print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                        answ = Prompt.ask("[?] DESEJA SAIR USE ( Y ) PARA SIM E ( N ) PARA NAO?", choices=["y", "n"], default="n")
                        if answ == "y": print(Colorate.Horizontal(Colors.rainbow, f'VOLTEM SEMPRE: @{eukillerofc}.'))
                        else: continue
                    else:
                        print(Colorate.Horizontal(Colors.rainbow, 'FALHA.'))
                        print(Colorate.Horizontal(Colors.rainbow, 'TENTE NOVAMENTE.'))
